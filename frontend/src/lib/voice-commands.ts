// ─────────────────────────────────────────────────────────────────
// SHERLOCK — Voice command parser (Phase 4: Voice-Controlled Board)
// Deliberately simple keyword/phrase matching, not full NLU — the
// commands are a fixed, small vocabulary so this is reliable without
...
interface Rule { pattern: RegExp; build: () => BoardVoiceCommand; }
